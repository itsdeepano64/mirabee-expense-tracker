...
import { Plus, ChevronRight, Download, CheckCircle2 } from "lucide-react";
                    ...
                    {inv.status !== "paid" && (
                      payingId === inv.id ? (
                        <div style={{
                          ...
                          <p style={{ fontSize: 12, fontWeight: 700, color: "var(--mb-green-dark)" }}>
                            Record Payment
                          </p>
                          <div>
                          ...
                          <div>
                            <label style={{ fontSize: 10, fontWeight: 600, color: "var(--mb-text-muted)", display: "block", marginBottom: 3 }}>
                              Notes (payment method, partial details, etc.)
                            </label>
                            <input
                              className="mb-field"
                              placeholder="e.g. Cash, Venmo @jenni, Check #1234..."
                              value={payNotes}
                        ...
                        <button
                          ...
                          style={{
                            ...
                            border: "1.5px solid var(--mb-green)",
